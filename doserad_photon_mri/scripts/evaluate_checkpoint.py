...
from doserad_photon_mri.inference import predict_record_volume, warmup_model  # noqa: E402
...
from doserad_photon_mri.dataset import lookup_condition  # noqa: E402
from doserad_photon_mri.dataset_index import read_mha_header  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate full photon-MRI control-point volumes from a checkpoint."
    )
