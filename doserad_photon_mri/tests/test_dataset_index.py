...
from doserad_photon_mri.dataset_index import audit_dataset, expected_dose_name  # noqa: E402
...
class DatasetIndexTest(unittest.TestCase):
    ...
    def test_complete_patient_is_added_to_audit(self) -> None:
        with tempfile.TemporaryDirectory() as temporary_directory:
            ...
            (patient_dir / "image" / "mr.mha").write_bytes(MHA_HEADER)
            metadata = {
                "beams": [
                    {
                        "beam_idx": 0,
            ...
            self.assertTrue(summary.patients[0].complete_for_photon_mri)
