...
from doserad_photon_mri.dataset import ManifestRecord  # noqa: E402
...
evaluation = load_module("photon_mri_evaluation", PROJECT_ROOT / "scripts/evaluate_checkpoint.py")
